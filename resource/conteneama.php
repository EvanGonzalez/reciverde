                    ...
                    <section class="main-article">
                        ...
                        <div class="accordion-container">
                            ...
                            <div class="accordion-tab">
                                ...
                                <label for="accordion-1">¿Qué se puede tirar en el contenedor amarillo?</label>
                            ...
                            <!-- ACCORDION-2 -->
                            <div class="accordion-tab">
                                <input type="checkbox" id="accordion-2" name="toCSS" />
                                <label for="accordion-2">¿Qué no se puede tirar en el contenedor amarillo?</label>
                                <div class="accordion-content">
                                    <p>
                            ...
                            <div class="accordion-tab">
                                ...
                                <label for="accordion-3">Cómo se recicla lo que tiramos en el contenedor amarillo</label>
                                <div class="accordion-content">
                                    <p>
                            ...
                            <div class="accordion-tab">
                                ...
                                <label for="accordion-4">Datos curiosos sobre el reciclaje en el contenedor amarillo</label>
                                <div class="accordion-content">
                                    <p>
