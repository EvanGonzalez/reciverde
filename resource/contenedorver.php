            ...
            <div class="contenedorverde">
                <article class="contenedorverde2">
                    ...
                    <section class="main-article">
                        ...
                        <p>Pero cuidado, no todo lo que parece vidrio es vidrio. Hay algunos objetos que están hechos de cristal o de otros materiales que no se pueden reciclar en el contenedor verde. </p>
                        <div class="gallery">
                            <div class="gallery-mask mask-off">
                                <img class="mask-image" src="" alt="" width="200">
                            </div>
                            <div class="image-item image-1" alt="" width="200" style="background-image: url('/img/masterpage-top-image-circles.png');"></div>
